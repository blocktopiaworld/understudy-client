...
func TestComponentPayloadsDecodeWhole(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{16, "attribute_modifiers",
			...
			[]string{"01000e6d696e6563726166743a746573744000000000000000000600", "02000b6d696e6563726166743a614000000000000000000600010b6d696e6563726166743a623ff0000000000000000600"}},
		...
		{54, "writable_book_content",
			...
			[]string{"010568656c6c6f00", "03036f6e65000374776f0005746872656500"}},
		{55, "written_book_content",
			"title T, author me, one page p1 as a text component",
			[]string{"015400026d65000108000270310000", "025454000461757468000208000270310008000270320000"}},
		{56, "trim",
		...
		{68, "firework_explosion",
			...
			[]string{"0401000000ff010000ff000001", "0203000000ff0000ff0000ff000002000000ff0000ff000101"}},
		{69, "fireworks",
		...
		{74, "pot_decorations",
			...
			[]string{"048208a60b82088208", "04a60ba70ba90baa0b"}},
		{75, "container",
		...
		{76, "block_state",
			"facing=north",
			[]string{"0106666163696e67056e6f727468", "02036c6974047472756506666163696e67056e6f727468"}},
		...
		{14, "can_place_on",
			"placeable on dirt",
			[]string{"0101020900000000", "02010209000000000103012500000000"}},
		{15, "can_break",
			"breaks dirt and stone, two blocks in one holder set",
			[]string{"010103090100000000", "01010409012500000000"}},
		{18, "tooltip_display",
			"shown, with damage hidden",
			[]string{"000103", "0102030d"}},
		...
		{26, "use_cooldown",
			...
			[]string{"4020000000", "4020000001116d696e6563726166743a6d7967726f7570"}},
		{27, "damage_resistant",
		...
		{36, "death_protection",
			...
			[]string{"00"}},
		{37, "blocks_attacks",
			"0.25 delay and 1.5 disable scale, once with every sound absent and once with a bypass tag and a block sound set",
			[]string{"3e8000003fc00000003f800000000000003f800000000000", "3e8000003fc00000003f800000000000003f8000000100116d696e6563726166743a69735f6669726501b90c00"}},
		{45, "map_color",
			"tinted 1234567",
			[]string{"0012d687"}},
		{47, "map_decorations",
		...
		{58, "entity_data",
			...
			[]string{"640a0100044e6f41490100", "640a08000a437573746f6d4e616d650007225065726379220500064865616c7468414800000100044e6f41490100"}},
		...
		{60, "block_entity_data",
			...
			[]string{"010a00", "010a08000a437573746f6d4e616d65000522426f78220800044c6f636b00036b657900"}},
		...
		{77, "bees",
			...
			[]string{"010b0a000a64", "020b0a000a640b0a00ac029003"}},
		{80, "break_sound",
			"a sound holder",
			[]string{"b90c"}},
		{5, "use_effects",
